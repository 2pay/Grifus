...
<div class="imputo">
<input class="buscar" TYPE="text" placeholder="<?php _e('Search..', 'mundothemes'); ?>" name="s" id="s" value="<?php echo $_GET['s'] ?>">
</div>
</form>
</div>
</div>
...
<h1><?php _e('Results','mundothemes'); ?>: <?php echo $_GET['s'] ?></h1>
...
<?php } ?>
<!-- ************PELICULAS*************** -->
<div class="<?php $dato = get_option('item_search'); echo stripslashes ($dato); ?> items">
<?php  if (have_posts()) : ?>
...
<?php 
if($item = get_option('item_search')) {
