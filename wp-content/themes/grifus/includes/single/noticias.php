<div id="noticias" style="margin-top:15px;">
<h2><?php _e('News', 'mundothemes'); ?></h2>
<?php $args = array( 'post_type' => 'noticias', 'showposts' => '2','orderby' => 'modified');$my_query = new WP_Query($args); ?>
