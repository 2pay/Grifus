<h2 class="css3"><?php _e('Comments','mundothemes') ?></h2>
...
<div class="fb-comments" data-href="<?php the_permalink() ?>" data-width="595" data-numposts="<?php if($dato = get_option('fb_numero')) { echo $dato; } else { echo '5'; } ?>" data-colorscheme="<?php if($color = get_option('fb_color')) { echo $color; } else { echo 'light'; } ?>"></div>
<?php } else { ?> 
